...
export default function Home() {
  ...
  return (
   <>
    <div onClick={handleClick} className="menu cursor-pointer fixed z-40 bg-[url(/blob-sm.svg)] bg-cover bg-no-repeat top-4 right-4 size-16 md:size-24 grid place-content-center gap-3">
    ...
    <div className="rounded-tl-3xl rounded-bl-3xl menu-pannel translate-x-full top-0 right-0 bg-theme pl-10 z-30 shadow-2xl fixed w-4/5 md:w-1/2 h-screen flex flex-col items-start justify-center gap-10">
      ...
      <div className="space-y-4">
        ...
        <button className="border border-dark rounded-full py-2 px-4 hover:scale-90 transition-all font-semibold">Resume</button>
      </div>
    </div>
    <Banner/>
